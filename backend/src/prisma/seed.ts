...
async function main() {
  ...
  // User default: Alfian
  const hashedPassword = await bcrypt.hash('24090135', 10);

  await prisma.user.upsert({
    where: { nim: '24090135' },
    update: {
      name: 'Alfian Farros Alfarisi',
  ...
  console.log('✅ User: NIM 24090135 / Password 24090135');
  ...
  console.log('👤 Login: NIM 24090135 / Password: 24090135');
}
